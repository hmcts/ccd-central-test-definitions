# ccd-central-test-definitions
Central Test Definiton file repository for CCD APIs with JSON Version Control

Aim is to maintain a Central definition file repository for Definitions related to CCD Apis with JSON version control
